...
interface IAvailableProductCardProps {
  product: IMyProductData;
}

export default function AvailableProductCard({
  product,
}: Readonly<IAvailableProductCardProps>) {
  ...
  return (
    <Link to={`/buy-and-rent-product/${product.id}`}>
